...
# ---------------------------------------------------------------
prism1 = Part.makeBox(5, 100, 75)         # (dx, dy, dz)
...
# ---------------------------------------------------------------
outer_half = Part.makeCylinder(13, 75, App.Vector(0, 0, 0),
                               App.Vector(0, 0, -1), 150)
inner_half = Part.makeCylinder(8, 75, App.Vector(0, 0, 0),
                               App.Vector(0, 0, -1), 150)
...
shell.translate(App.Vector(-8, 0, 75))
